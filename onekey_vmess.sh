	...
	"inbounds": [
		{
			...
			"settings": {
				"clients": [
					{
						"id": "bc2ea926-5b40-5312-aa03-f3a417ef06c5",
						"alterId": 0
					}
				]
			},
...
echo 'vmess://'$(echo '{"add":"104.16.25.33","aid":"0","host":"'$argo'","id":"bc2ea926-5b40-5312-aa03-f3a417ef06c5","net":"ws","path":"","port":"443","ps":"argo v2ray","tls":"tls","type":"none","v":"2"}' | base64 -w 0)